  ...
  outputs = { self, nixpkgs, crane, rust-overlay, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        # zcash/zallet#540, each directory under backends/ is its
        ...
        # (for example, backends/zebra → zallet-zebra),
        ...
        # union of all graphs and is generated by `gen-copyright` on the
        ...
        mkZallet = { manifestDir ? null, binName, features ? [ ], collectShare ? false }:
          ...
          # deliberately decouples the resolution graphs) — so that
        ...
        # tree that the deb + StageX export consume (all backends generate
        ...
        zallet-zinder = mkZallet {
          manifestDir = "backends/zinder";
          binName = "zallet-zinder";
          features = [ "rpc-cli" "zcashd-import" ];
        };
        ...
        # every backend side by side, plus the share tree.
        zallet = pkgs.symlinkJoin {
          name = "zallet";
          paths = [ zallet-launcher zallet-zebra zallet-zaino zallet-zinder ];
        };
      in {
        ...
        packages.zallet-zinder = zallet-zinder;
      });
}
